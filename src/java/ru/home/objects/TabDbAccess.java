...
public class TabDbAccess extends HTMLElement {
    final static private String NAME="DbAccess";
    final static private String LOCATOR=Locators.get("Price.Dbaccess");

    public TabDbAccess(WebDriver driver) {
